...
import us.polarismc.api.MainAPI;
...
public class ItemBuilder {
    ...
    public ItemBuilder lore(String... msgs) {
        ...
        Arrays.stream(msgs).forEach(s -> lore.add(utils.chat("&7" + s)));
    ...
    public ItemBuilder lore(List<String> msgs) {
        List<Component> lore = new ArrayList<>();
        msgs.forEach(s -> lore.add(utils.chat("&7" + s)));
        this.meta.lore(lore);
        return this;
    }
